...
export const mockTickets: Ticket[] = [
  ...
  { id: "2", key: "Z10LMC-3002", summary: "Database connection pool exhaustion", priority: "P1", status: "In Progress", assignee: "Mike Torres", reporter: "Alert System", createdAt: hoursAgo(6), updatedAt: hoursAgo(2), lastManagerComment: hoursAgo(4), hasNewActivity: true, isUnattended: false, slaDeadline: hoursAgo(2), slaBreached: true, project: "Z10LMC", commentSynced: true, watchers: ["Manager"], lastComment: { author: "Mike Torres", time: hoursAgo(2), text: "Pool size increased, monitoring" } },
